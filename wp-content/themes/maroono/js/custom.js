...
(function() {
    ...
    function showCharactersList() // function to create rewuest to access json file
    {
        request = create();
    ...
    function createList(request) // Creating List of data to show in tabular form 
    {

        var charnames = JSON.parse(request.responseText);
        var available_docks = 0; 
